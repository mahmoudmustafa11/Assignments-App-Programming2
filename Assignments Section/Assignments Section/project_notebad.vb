...
Public Class project_notebad
    ...
    Private Sub btn_aboutApp_Click(sender As Object, e As EventArgs)
        AboutNotebad.Show()
    End Sub
    ...
    Private Sub btn_aboutApp_Click_1(sender As Object, e As EventArgs) Handles btn_aboutApp.Click
        AboutNotebad.Show()
    End Sub
End Class